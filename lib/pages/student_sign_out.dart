...
class StudentSignOutPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _StudentSignOutStatePage();  
  }
}

class _StudentSignOutStatePage extends State<StudentSignOutPage> {

  String barcode = '';
  bool isScanned = false;

  Future scanForOut() async {
    try {
              ...
              ? RaisedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CheckOut(barcode: this.barcode)
                    )
                  );
                },
              )
    ...
    final optionCardContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text('Student Out', style: headerTextStyle,),
          new Container(height: 10.0,),
          new Text('Click here to check-out student', style: subHeaderTextStyle,)
        ],
      ),
    );
